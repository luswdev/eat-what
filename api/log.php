...
if ($update) {
    ...
    file_put_contents("../data/access.log", "[$now] ($ip) Add a new result row: $LastID".PHP_EOL, FILE_APPEND);
    ...
    file_put_contents("../data/access.log", "[$now] ($ip) Access result of $when: $res".PHP_EOL, FILE_APPEND);
} else {
    ...
    file_put_contents("../data/access.log", "[$now] ($ip) Access results log page.".PHP_EOL, FILE_APPEND);
}
